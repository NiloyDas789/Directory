    ...
    <header class="site-navbar" role="banner">
      ...
      <div class="row align-items-center" style='background: antiquewhite;'>
          ...
          <div class="col-4 site-logo">
            ...
            <img src='http://127.0.0.1:8000/storage/directory/1618223638.png' style='width: 300px; height: 90px; padding: 15px;' alt='logo'>
        ...
        <div class="row">
          <div class="col-12 text-center">
            <p>
              ...
              Copyright &copy; <script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="icon-heart text-danger" aria-hidden="true"></i> by </a>
              <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
              </p>
          </div>
        </div>
